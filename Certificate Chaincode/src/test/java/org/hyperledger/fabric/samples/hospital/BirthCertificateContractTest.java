...
public class BirthCertificateContractTest {
    ...
    public void issueBirthCertificateTest(){
        ...
        MotherInfo motherInfo = new MotherInfo("Mervat Hassan AbdelHamed AbdelGhany", "00",
                                                "Egyptian","Islam");

        FatherInfo fatherInfo = new FatherInfo("Nashaat Serry AbdelBar AbdelGawad", "00",
                                                "Egyptian","Islam");
    ...
    public void getBirthCertificateTest(){
        ...
        when(stubMock.getStringState("001")).thenReturn("{\"birthPlace\":\"Giza\",\"dateOfBirth\":\"05-11-1998\"," +
                "\"fatherInfo\":{\"fullName\":\"Nashaat Serry AbdelBar AbdelGawad\",\"nationality\":\"Egyptian\",\"picture\":\"00\"," +
                "\"religion\":\"Islam\"},\"fullName\":\"Arwa Nashaat Serry AbdelBar\",\"gender\":\"Female\"," +
                "\"motherInfo\":{\"fullName\":\"Mervat Hassan AbdelHamed AbdelGhany\",\"nationality\":\"Egyptian\",\"picture\":\"00\"," +
