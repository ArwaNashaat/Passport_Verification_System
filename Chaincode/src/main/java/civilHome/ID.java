...
public final class ID {
    ...
    @Property()
    private final byte[] personalPicture;
    ...
    public ID(@JsonProperty("IDNumber") final String IDNumber, @JsonProperty("address") final String address,
              ...
              @JsonProperty("personalPicture") final byte[] personalPicture)
    {
    ...
    public byte[] getPersonalPicture(){ return personalPicture;}
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.deepEquals(new String[] {getIDNumber(), getAddress(), getFullName(), getGender(),
                ...
                String.valueOf(getExpireDate()), String.valueOf(getIsExpired()), String.valueOf(getPersonalPicture())},
                new String[] {other.getIDNumber(), other.getAddress(), other.getFullName(), other.getGender(),
              	other.getReligion(), other.getJob(), other.getMaritalStatus(), other.getNationality(),
                        ...
                        String.valueOf(other.getIsExpired()), String.valueOf(other.getPersonalPicture())});
    }
    ...
    public int hashCode() {
        return Objects.hash(getIDNumber(), getAddress(), getFullName(), getGender(),
                ...
                getExpireDate(),getIsExpired(), getPersonalPicture());
    }

    @Override
    public String toString() {
        return this.getClass().getSimpleName()  + " [IDNumber=" + IDNumber + ", address="
                + address + ", fullName=" + fullName + ", gender=" + gender  + ", religion=" + religion +
                ", job=" + job + ", maritalStatus=" + maritalStatus + ", nationality=" + nationality +
                ", dateOfBirth="+dateOfBirth + ", expireDate=" + expireDate + ", ID Expired=" + isExpired + ", personalPicture" + personalPicture+"]";
    }
}
